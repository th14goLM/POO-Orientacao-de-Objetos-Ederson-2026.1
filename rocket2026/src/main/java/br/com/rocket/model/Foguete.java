...
public class Foguete {
    ...
    // Relacionamento: um foguete carrega um satélite
    @OneToOne
    ...
    // --- Regras de negócio (lógica que estava no original) ---
    ...
    public void lancar() {
        ...
        if (this.combustivelRestante < 50) {
            ...
            throw new IllegalStateException(
                nome + " não possui combustível suficiente! (Mínimo: 50 toneladas, atual: " + combustivelRestante + ")"
            );
        }
